...
<section class="video-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>Update video date and time <span>*</span></p>
      <input type="datetime-local" name="video_date" value="<?= date('Y-m-d\TH:i', strtotime($fecth_videos['video_date'])); ?>" required class="box">
