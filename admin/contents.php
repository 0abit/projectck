...
<section class="contents">
   ...
   <?php
      $select_videos = $conn->prepare("SELECT * FROM `content` WHERE tutor_id = ? ORDER BY date ASC");
   ...
   ?>
      <div class="box">
         <div class="flex">
            ...
            <div><i class="fas fa-calendar"></i><span>Uploaded on: <?= date('Y-m-d H:i:s', strtotime($fetch_videos['date'])); ?></span></div>
         </div>
