...
<body>
   ...
   <section class="comments">
      ...
      <div class="show-comments">
         <?php
         // Update the query to fetch comments based on content_id
         ...
         ?>
               <div class="box" style="<?php if ($fetch_comment['user_id'] == $tutor_id) {
                                          echo 'order:-1;';
                                       } ?>">
                  <div class="content"><span><?= $fetch_comment['date']; ?></span>
                     <p> - <?= $fetch_content['title']; ?> - </p><a href="view_content.php?get_id=<?= $fetch_content['id']; ?>">view content</a>
                  </div>
