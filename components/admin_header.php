<?php
if (!isset($display_messages)) {
    $display_messages = []; // Initialize as an empty array if not set
}
...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="dashboard.php" class="logo">Cuong Academy</a>
...
<div class="side-bar">
   ...
   <nav class="navbar">
      ...
      <a href="view_contact.php"><i class="fas fa-envelope"></i><span>messages</span></a>
   </nav>
